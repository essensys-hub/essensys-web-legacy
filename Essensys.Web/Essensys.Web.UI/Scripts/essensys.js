...
$(document).ready(function () {
    ...
    $("#openvol").bind("click", function (e) {
        ...
        $.each($(ct).find("input[value=1]"), function (iv, ov) {
            if (chk != "1") {
                if (!$(ov).is(":checked")) {
                    if ($(ov).attr('id') != 'store' && $(ov).attr("disabled") != "disabled") {
                        $(ov).click();
                        b.attr("data-chk", "1");
                        $("#closevol").attr("data-chk", "0");
                    }
                }
            }
            else {
                if ($(ov).is(":checked")) {
                    if ($(ov).attr('id') != 'store' && $(ov).attr("disabled") != "disabled") {
                        ...
                        $(ov).removeClass("ch");
                        if ($(ov).parent().parent().find(".ch").length == 0) {
                            $(ov).parent().parent().parent().find('span').hide();
                            $(ov).parent().parent().parent().css('padding-top', dec);
                            $(ov).parent().parent().removeClass('tovalidate');
                        }
                    }
                }
            }
            ...
            if (chk != "1") {
                ...
                if ($(ov).is(":checked")) {
                    if ($(ov).attr('id') != 'store' && $(ov).attr("disabled") != "disabled") {
                        $(ov).prop("checked", false);
                        $(ov).removeClass("ch");
                        if ($(ov).parent().parent().parent().find(".ch").length == 0) {
                            $(ov).parent().parent().parent().parent().find('span').hide();
                            $(ov).parent().parent().parent().parent().css('padding-top', dec);
                            $(ov).parent().parent().parent().removeClass('tovalidate');
                        }
                    }
                }
            }
    ...
    $(".esys-zone input[type=radio]").bind("click", function () {
        if ($(this).hasClass("radiocol1") || $(this).hasClass("radiocol2")) {
            if ($(this).hasClass("ch")) {
                $(this).removeClass("ch");
                $(this).removeAttr("checked");
                if ($(this).parent().parent().parent().parent().attr("id") == "eclairage") {
                    if ($(this).parent().parent().parent().find(".ch").length == 0) {
                        $(this).parent().parent().parent().parent().find('span').hide();
                        $(this).parent().parent().parent().parent().css('padding-top', dec);
                        $(this).parent().parent().parent().removeClass('tovalidate');
                    }
                }
                else {
                    if ($(this).parent().parent().find(".ch").length == 0) {
                ...
                $(this).addClass("ch");
                if ($(this).hasClass("radiocol1"))
                    $(this).parent().find(".radiocol2").removeClass("ch");
                if ($(this).hasClass("radiocol2"))
                    $(this).parent().find(".radiocol1").removeClass("ch");
                if ($(this).parent().parent().parent().parent().attr("id") == "eclairage") {
                    $(this).parent().parent().parent().parent().find('span').show();
                    $(this).parent().parent().parent().parent().css('padding-top', '0px');
                    $(this).parent().parent().parent().addClass('tovalidate');
                }
                else {
